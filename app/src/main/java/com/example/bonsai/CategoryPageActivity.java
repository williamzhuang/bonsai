...
public class CategoryPageActivity extends Activity {
     ...
     */
    private MobileServiceTable<SkillNode> mSkillNodeTable;

    //Offline Sync
    /**
     * Mobile Service Table used to access and Sync data
     */
    //private MobileServiceSyncTable<SkillNode> mSkillNodeTable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Load subcategories and trees based on the number.
        // Update title based on the number.
        ...
        try {
            ...
            mSkillNodeTable = mClient.getTable(SkillNode.class);

            // Offline Sync
            //mSkillNodeTable = mClient.getSyncTable("SkillNode", SkillNode.class);
            ...
            ListView listViewSkillNode = (ListView) findViewById(R.id.listViewSkillNode);
            listViewSkillNode.setAdapter(mAdapter);
    ...
    public void addItem(View view) {
        ...
        item.setText(mTextNewSkillNode.getText().toString());
    ...
    public SkillNode addItemInTable(SkillNode item) throws ExecutionException, InterruptedException {
        SkillNode entity = mSkillNodeTable.insert(item).get();
        return entity;
    }
    ...
    private List<SkillNode> refreshItemsFromMobileServiceTable() throws ExecutionException, InterruptedException {
        return mSkillNodeTable.where().field("complete").
    ...
    /*private List<SkillNode> refreshItemsFromMobileServiceTableSyncTable() throws ExecutionException, InterruptedException {
        ...
        Query query = QueryOperations.field("complete").
                eq(val(false));
        return mSkillNodeTable.read(query).get();
    }*/
